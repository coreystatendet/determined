...
func (a *Allocation) TaskContainerStateChanged(
	...
	case cproto.Running:
		...
		a.sendEvent(ctx, sproto.Event{ContainerStartedEvent: &sproto.ContainerStartedEvent{
			Container:            msg.Container,
			TaskContainerStarted: *msg.ContainerStarted,
		}})
...
func (a *Allocation) enrichEvent(ctx *actor.Context, ev sproto.Event) sproto.Event {
	...
	case ev.ContainerStartedEvent != nil:
		ev.ContainerID = string(ev.ContainerStartedEvent.Container.ID)
	}
	return ev
}
